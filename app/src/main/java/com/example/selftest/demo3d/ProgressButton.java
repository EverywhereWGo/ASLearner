...
public class ProgressButton extends AppCompatButton {
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        int defaultButtonColor = getResources().getColor(R.color.purple_200, null);
        //Get default progress color
        int defaultProgressColor = getResources().getColor(R.color.teal_200, null);
        //Get default progress background color
        int defaultBackColor = getResources().getColor(R.color.purple_200, null);
